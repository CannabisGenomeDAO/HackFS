      ...
      <div className="flex items-center flex-col flex-grow pt-10">
        <div className="px-5">
          <h1 className="text-center mb-8">
            ...
            <span className="block text-4xl font-bold">Cannabis Genome DAO
</span>
          </h1>
          <p className="text-center text-lg">To incentivize participation in open-source cannabis genome research.</p>
          <p className="text-center text-lg">The Genome DAO platform revolutionizes the way datasets are discovered, published, and exchanged. Users can effortlessly explore an extensive collection of datasets, ranging from diverse fields and
